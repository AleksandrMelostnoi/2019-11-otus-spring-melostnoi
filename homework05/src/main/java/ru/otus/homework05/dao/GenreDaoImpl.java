...
public class GenreDaoImpl implements GenreDao {
    ...
    public boolean checkByName(String genreName) {
        ...
        List queryResult = jdbcOperations.query("select * from genre where name = :name", params, new GenreMapper());
    ...
    public Genre getByName(String genreName) {
        final Map<String, Object> params = new HashMap<>(1);
        params.put("name", genreName);
        return jdbcOperations.queryForObject("select * from genre where name = :name", params, new GenreMapper());
    }
